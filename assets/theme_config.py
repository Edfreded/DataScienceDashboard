...
def setup_retro_plotly_theme():
    """Set up the retro purple-pink Plotly theme to match CSS"""
    pio.templates["retro_purple"] = {
        'layout': {
    ...
    pio.templates.default = "retro_purple"

# Theme configuration
THEME_CONFIG = {
    'css_file': 'retro_theme.css',
